...
def main():     #csv file contains my name and small(56) and large(28) data set i should use        SMALL 86: 57 seconds to run, LARGE 27: 
    ...
    fileName = "Data/Ver_2_CS170_Fall_2021_LARGE_data__27.txt"
...
def feature_search_demo(data):
    ...
    for i in range(1, numOfFeatures):
        ...
        if (timeElapsed > 3200) or (accDecreasing and highestAccuracy > best_so_far_accuracy):
            break
        if(highestAccuracy > best_so_far_accuracy):
            accDecreasing = True
